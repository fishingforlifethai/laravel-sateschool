        ...
        <div class="w-full mt-8 bg-white rounded">
            ...
            <div class="w-full px-6 py-6">
                <div class="flex items-center justify-between bg-gray-600 rounded-tl rounded-tr">
                    <div class="w-3/12 text-left text-white py-2 px-4 font-semibold">วันที่</div>
                    <div class="w-3/12 text-left text-white py-2 px-4 font-semibold">อาจารย์</div>
                    <div class="w-3/12 text-left text-white py-2 px-4 font-semibold">คลาสเรียน</div>
                    <div class="w-3/12 text-right text-white py-2 px-4 font-semibold">ตารางเรียน</div>
                </div>
