...
@section('content')
    <div class="roles">
        ...
        <div class="flex items-center justify-between mb-6">
            <div>
                <h2 class="text-gray-700 uppercase font-bold">กำหนด วิชา</h2>
            </div>
        ...
        <div class="w-full py-12">
            <h2 class="text-gray-700 uppercase font-bold my-2">นักเรียน</h2>
            <div class="flex items-center bg-gray-600">
                <div class="w-1/4 text-left text-white py-2 px-4 font-semibold">ชื่อ</div>
                <div class="w-1/4 text-left text-white py-2 px-4 font-semibold">อีเมล</div>
                <div class="w-1/4 text-right text-white py-2 px-4 font-semibold">เบอร์โทรศัพท์</div>
                <div class="w-1/4 text-right text-white py-2 px-4 font-semibold">ผู้ปกครอง</div>
            </div>
