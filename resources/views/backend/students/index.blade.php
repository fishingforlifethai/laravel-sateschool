...
@section('content')
    <div class="roles-permissions">
        <div class="flex items-center justify-between mb-6">
            <div>
                <h2 class="text-gray-700 uppercase font-bold">นักเรียน</h2>
            </div>
            <div class="flex flex-wrap items-center">
                <a href="{{ route('student.create') }}" class="bg-green-500 text-white text-sm uppercase py-2 px-4 flex items-center rounded">
                    ...
                    <span class="ml-2 text-xs font-semibold">เพิ่ม นักเรียน</span>
                </a>
            </div>
        </div>
        ...
        <div class="mt-8 bg-white rounded border-b-4 border-gray-300">
            <div class="flex flex-wrap items-center uppercase text-sm font-semibold bg-gray-600 text-white rounded-tl rounded-tr">
                ...
                <div class="w-2/12 px-4 py-3">คลาสเรียน</div>
                <div class="w-2/12 px-4 py-3">เบอร์โทรศัพท์</div>
                <div class="w-2/12 px-4 py-3 text-right">เพิ่ม/ลบ</div>
            </div>
